...
export default function NavigationRight({
    ...
    menu1OpenInNewTab = componentDefaults["navigation-right"].menu1OpenInNewTab,
    menu1Visible = true,
    ...
    menu2OpenInNewTab = componentDefaults["navigation-right"].menu2OpenInNewTab,
    menu2Visible = true,
    ...
    menu3OpenInNewTab = componentDefaults["navigation-right"].menu3OpenInNewTab,
    menu3Visible = true,
    ...
    menu4OpenInNewTab = componentDefaults["navigation-right"].menu4OpenInNewTab,
    menu4Visible = true,
