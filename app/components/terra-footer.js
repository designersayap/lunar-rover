            ...
            <div className="container-grid">
                <div className="grid">
                    ...
                    <div className={`col-mobile-2 col-tablet-8 col-desktop-8 ${styles.brandColumn}`}>
                        <h4 className={`h4 ${styles.title}`}>Brand</h4>
                    ...
                    <div className={`col-mobile-2 col-tablet-8 col-desktop-2 ${styles.linksColumn}`}>
                        <h4 className={`body-regular ${styles.title}`}>Products</h4>
                        <ul className={styles.linkList}>
                            <li><a href="#" className={`body-regular ${styles.linkItem}`}>Fabric Care</a></li>
                            <li><a href="#" className={`body-regular ${styles.linkItem}`}>Food & Beverage</a></li>
                            <li><a href="#" className={`body-regular ${styles.linkItem}`}>Home Care</a></li>
                        </ul>
                    </div>

                    {/* Follow Us Column (col-2) */}
                    <div className={`col-mobile-2 col-tablet-8 col-desktop-2 ${styles.linksColumn}`}>
                        <h4 className={`body-regular ${styles.title}`}>Follow Us</h4>
                        <ul className={styles.linkList}>
                            <li>
                                <a href="#" className={`body-regular ${styles.linkItem}`}>
                ...
                <div className={styles.bottomBar}>
                    ...
                    <div className={styles.legalLinks}>
                        <a href="#" className={`caption-regular ${styles.legalLink}`}>Terms & Conditions</a>
                        <a href="#" className={`caption-regular ${styles.legalLink}`}>Privacy Policy</a>
                    </div>
                </div>
            </div>
        </footer>
